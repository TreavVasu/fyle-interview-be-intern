...
from core.apis.assignments import student_assignments_resources,teacher_assignment_resource
...
app.register_blueprint(teacher_assignment_resource, url_prefix='/teacher')
